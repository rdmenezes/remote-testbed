...
import diku.distlab.motecontrolclientlib.protocols.motecontrol.MsgCommand;
import diku.distlab.motecontrolclientlib.protocols.motecontrol.MsgResult;
...
import diku.distlab.remote.client.motedata.TableListener;
...
public class MoteControlTable implements MoteListListener, SimpleMoteStatusListener, Table {
	...
	public MoteControlTable(MoteList moteList)
	{
		...
		// create mote controls and add to the list
